  ...
  return (
    <>
      ...
      <section className="introSection mt-5 px-3 sm:px-6 md:px-10 flex flex-col items-center w-full">
        <div className="headingText text-2xl sm:text-7xl md:text-[10em] lg:text-[14em] w-full h-[70px] sm:h-[250px] md:h-[350px] flex justify-center items-center bg-[#1B1B19] text-center opacity-90 select-none rounded-[10px] sm:rounded-[15px] tracking-[3px] sm:tracking-[5px]">
